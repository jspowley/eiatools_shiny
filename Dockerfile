...
RUN R -e "install.packages(c('devtools', 'shiny', 'bslib', 'tidyverse', 'eiatools', 'DT', 'rlang', 'rhandsontable', 'plotly', 'shinyalert'), dependencies = TRUE, repos = 'https://packagemanager.rstudio.com/cran/latest')"
